    ...
    <v-row class="row1">
      <v-col>
        ...
        <v-text-field v-model="start" label="Start date" type="Date" dense solo-inverted class="mr-5"
          :style="{ maxWidth: '300px' }" flat></v-text-field>
        <v-text-field v-model="end" label="End date" type="Date" dense solo-inverted class="mr-5"
          :style="{ maxWidth: '300px' }" flat></v-text-field>
        <br />
        <v-btn text="Analyze" @click="updateLineCharts(); updateHistogramCharts(); updateScatter(); updateCards();" color="primary" variant="tonal"></v-btn>
      </v-col>
